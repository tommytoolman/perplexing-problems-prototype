...
const chapterCatalog = {
  ...
  "6": {
    ...
    problems: Array.from({ length: 5 }, (_, index) => `6.${index + 1}`),
  },
  "7": {
    number: "7",
    title: "Mad inventions and perpetual motion",
    problems: Array.from({ length: 6 }, (_, index) => `7.${index + 1}`),
  },
  "8": {
    number: "8",
    title: "Kinematics",
    problems: Array.from({ length: 3 }, (_, index) => `8.${index + 1}`),
  },
  "9": {
    number: "9",
    title: "Electricity",
    problems: Array.from({ length: 7 }, (_, index) => `9.${index + 1}`),
  },
  "10": {
    number: "10",
    title: "Gravity",
    problems: Array.from({ length: 12 }, (_, index) => `10.${index + 1}`),
  },
  "11": {
    number: "11",
    title: "Optics",
    problems: Array.from({ length: 5 }, (_, index) => `11.${index + 1}`),
  },
  "12": {
    number: "12",
    title: "Heat",
    problems: Array.from({ length: 5 }, (_, index) => `12.${index + 1}`),
  },
  "13": {
    number: "13",
  ...
  "19": {
    ...
    problems: Array.from({ length: 6 }, (_, index) => `19.${index + 1}`),
  },
  "20": {
    number: "20",
    title: "Relativity and spacetime",
    problems: Array.from({ length: 6 }, (_, index) => `20.${index + 1}`),
  },
  "21": {
    number: "21",
